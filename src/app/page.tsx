...
import { getActiveListings } from "@/server/queries";
    ...
    <main className="mx-auto max-w-6xl px-4 py-10">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-300">
          Listagens ativas (compra por preço fixo). Para listar, abra uma skin em{" "}
      ...
      {listings.length === 0 ? (
        <div className="mt-8 rounded-lg border border-dashed border-zinc-300 p-6 text-sm text-zinc-600 dark:border-zinc-800 dark:text-zinc-300">
          Nenhuma listing ativa ainda. Faça login e liste uma skin sua.
        </div>
      ) : (
              ...
              <div className="mt-3 flex items-start justify-between gap-3">
                <div>
                  ...
                  <div className="text-xs text-zinc-600 dark:text-zinc-300">
                    #{String(l.tokenId).padStart(3, "0")} · {l.rarity} · vendedor: {l.sellerEmail}
                  </div>
                </div>
